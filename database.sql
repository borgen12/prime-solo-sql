...
3. The bank is giving a new customer bonus! How do you update all records with an account balance of 0.00 and a 
transactions_attempted of 0? Give them a new account balance of 10.00.
-SELECT *FROM "accounts" WHERE "transactions_completed"='0' AND "account_balance" = '0.00';
...
-SELECT * FROM "accounts" WHERE "transactions_completed" >= '9';

5. How do you get the username and account balance of the 3 users with the highest balances, sorted highest to lowest balance? 
NOTE: Research LIMIT
